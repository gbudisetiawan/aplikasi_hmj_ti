              ...
              child: Row(
                children: <Widget>[
                  Container(
                    ...
                    child: new Image(image:AssetImage('images/user.png'),fit: BoxFit.cover,)
                  ),
                  Expanded(
                    child: Container(
                    ...
                    child: Container(
                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          ...
                          Text("S1 Pendidikan Teknik Informatika",style: TextStyle(fontSize: 13,),),
                          Text("Koordinator Program Studi S1 Pendidikan Teknik Informatika ",style: TextStyle(fontSize: 13,),),
                        ],
                      ),
